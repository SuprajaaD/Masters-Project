...
Decay_Z_prime = Decay(name = 'Decay_Z_prime',
                particle = P.Z_prime,
                partial_widths = {(P.W__minus__,P.W__plus__):'((-(complex(0,1)*ee*x*(1 + x)))**2*cmath.sqrt(MZ_prime**2 - MW**2)*(1 + (16.*MW**2/MZ_prime**2) - (68.*MW**4/MZ_prime**4) - (48.*MW**6/MZ_prime**6))) /(192.*cmath.pi)',
                                  (P.Z,P.H):'((-(complex(0,1)*ee**2*vev*x*cosw**2*secw)/2.)**2*(2 + (MZ_prime**2 + MZ**2 - MH**2)**2/(4*MZ_prime**2*MZ**2))*(cmath.sqrt(1 + (MH**2 - MZ**2)**2/(MZ_prime**2) - 2*(MH**2 + MZ**2)**2/(MZ_prime**2))))/(48.*cmath.pi*abs(MZ_prime))',
                                  (P.phi0,P.phi3):'((-(complex(0,1)*((ee*cosw**2)/(2*x) + (ee*(2*cotw + 3*tw)*x)))**2*(MZ_prime**2 -4*Mphi_plus**2)*(cmath.sqrt(1 + (Mphi0**2 - Mphi**2)**2/(MZ_prime**2) - 2*(Mphi0**2 + Mphi3**2)**2/(MZ_prime**2)))))/(48.*cmath.pi*abs(MZ_prime))',
                                  (P.phi_plus,P.phi_minus):'(((complex(0,1)*ee*cosw**2)/(2*x) - ((complex(0,1)*ee*(2*cotw + tw)*x))/(4*secw))**2*(MZ_prime**2 - (MZ_prime**2 -2*(MZ**2 - MH**2)))*(cmath.sqrt(1 - 4*(Mphi_plus**2/MZ_prime**2))))/(192.*cmath.pi*abs(MZ_prime))',
                                  (P.u,P.u__tilde__):'(3*(ee*x/((2*sw))**2*MZ_prime**2))**2 /(48.*cmath.pi)',
                                  (P.c,P.c__tilde__):'(3*(ee*x/((2*sw))**2*MZ_prime**2))**2 /(48.*cmath.pi)',
                                  (P.t,P.t__tilde__):'(3*(ee*x/((2*sw))**2*MZ_prime**2))**2 /(48.*cmath.pi)',
                                  (P.ve,P.ve__tilde__):'(ee*x/((2*sw)**2*MZ_prime**2))**2 /(48.*cmath.pi)',
                                  (P.vm,P.vm__tilde__):'(ee*x/((2*sw)**2*MZ_prime**2))**2 /(48.*cmath.pi)',
                                  (P.vt,P.vt__tilde__):'(ee*x/((2*sw)**2*MZ_prime**2))**2 /(48.*cmath.pi)'})
