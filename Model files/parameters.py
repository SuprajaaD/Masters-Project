...
# Trigonometric terms of weinberg angle
...
# Guage coupling constants                                                      
                          
g1 = Parameter(name = 'g1',           # In DM model g2
               nature = 'internal',
               type = 'real',
               value = 'ee/cw',
               texname = 'g_1')

gw = Parameter(name = 'gw',           # In DM model g1
               nature = 'internal',
               type = 'real',
               value = 'ee/sw',
               texname = 'g_w')
...
lam23_tilde = Parameter(name = 'lam23_tilde',
               nature = 'external',
               type = 'real',
               value = 0.,
               texname = '\\text{lam23_tilde}',
               lhablock = 'DMINPUTS',
               lhacode = [ 4 ])
...
#Guage coupling constant
                
g0 = Parameter(name = 'g0',            # In DM model g0 - value I have taken is similar to g1 and g2(not the calculated one, approx)
               nature = 'internal',
               type = 'real',
               value = 'gw/x',
               texname = 'g_0')
...
cosw = Parameter(name = 'cosw',                       # DM model cosec 
               nature = 'internal',
               type = 'real',
               value = '1/cmath.sqrt(sw2)',
               texname = 'cos_w') 
              
secw = Parameter(name = 'secw',                       # DM model sec 
               nature = 'internal',
               type = 'real',
               value = '1/cmath.sqrt(1 - sw2)',
               texname = 'sec_w') 
               
tw = Parameter(name = 'tw',                            # DM model tan
               nature = 'internal',
               type = 'real',
               value = 'cmath.sqrt(sw2/(1 - sw2))',
               texname = 't_w')  
               
cotw = Parameter(name = 'cotw',                           # DM model cot
               nature = 'internal',
               type = 'real',
               value = 'cmath.sqrt((1 - sw2)/sw2)',
               texname = 'cot_w') 
...
MZ_prime = Parameter(name = 'MZ_prime',
               nature = 'internal',
               type = 'real',
               value = 'cmath.sqrt((g0**2*F**2*(1+x**2))/4.)',          #Zprime mass
               texname = '\\text{MZ_prime}')
                                
               
               
MW_prime = Parameter(name = 'MW_prime',
               nature = 'internal',
               type = 'real',
               value = 'cmath.sqrt((g0**2*F**2*(1+x**2))/4.)',            #Wprime mass
               texname = '\\text{MW_prime}')
                               

Mphi0 = Parameter(name = 'Mphi0',
               nature = 'internal',                                 
               type = 'real',
               value = 'cmath.sqrt(M2**2 - lam23*F**2)',
               texname = '\\text{Mphi0}')
...
Mphi3 = Parameter(name = 'Mphi3',
               nature = 'internal',
               type = 'real',
               value = 'cmath.sqrt((M2**2) + lam23*F**2 + (2*lam23_tilde*F**2))',
               texname = '\\text{Mphi3}')
...
WZ_prime = Parameter(name = 'WZ_prime',
               nature = 'internal',
               type = 'real',
               value = 'cmath.sqrt(g0**2*F**2*(1+x**2)/4.)*(10./100.)',
               texname = '\\text{WZ_prime}')                   #value?
               

WW_prime = Parameter(name = 'WW_prime',
               nature = 'internal',
               type = 'real',                                   #value?
               value = 'cmath.sqrt(g0**2*F**2*(1+x**2)/4.)*(10./100.)',
               texname = '\\text{WW_prime}')
                            
Wphi3 = Parameter(name = 'Wphi3',
               nature = 'internal',
               type = 'real',
               value = '(cmath.sqrt((M2**2) + lam23*F**2 + (2*lam23_tilde*F**2)))*(10./100.)',
               texname = '\\text{Wphi3}')               
                                                         
Wphi0 = Parameter(name = 'Wphi0',
               nature = 'internal',                                 
               type = 'real',
               value = '(cmath.sqrt(M2**2 - lam23*F**2))*(10./100.)',
               texname = '\\text{Wphi0}')    
